...
with st.form("followup_form"):
    ...
    with col2:
        ...
        objection = st.selectbox("Main Concern / Objection", OBJECTIONS, index=1)
        financing = st.selectbox("Financing Discussed?", FINANCING_OPTIONS)
        urgency = st.selectbox("Urgency Level", URGENCY_LEVELS, index=1)
        tone = st.selectbox("Preferred Tone", TONES, index=1)

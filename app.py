...
with st.sidebar:
    st.title("FollowUpPilot AI"); st.caption("Version 2.4")
...
html_card("Portfolio Skills Shown", "<ul><li>AI-enhanced communication with rules-based fallback</li><li>Workflow mapping</li><li>Rules-based next-best-action logic</li><li>Sales communication generation</li><li>CRM documentation support</li><li>Downloadable business reports</li></ul>", "workflow-card")
